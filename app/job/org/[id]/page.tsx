      ...
      <div className="pt-20 pb-24 px-4">
        <div className="max-w-[1128px] mx-auto">
          ...
          >
            ...
            <span className="text-sm font-bold uppercase tracking-widest">Back to Jobs Hub</span>
          </button>
          ...
          {isLoading && (
            <div className="flex flex-col items-center justify-center py-32 gap-4">
              ...
              <p className="text-xs font-bold text-slate-600 uppercase tracking-widest animate-pulse">Decoding organization signal...</p>
            </div>
          )}
          ...
          {orgError && !isLoading && (
            <div className="bg-[#15161a] border border-red-500/20 rounded-3xl p-16 text-center shadow-2xl">
              ...
              <h3 className="text-lg font-bold text-red-400 mb-2">Signal Lost</h3>
              <p className="text-sm text-slate-500 mb-6">Unable to decode the organization data from the Aether network.</p>
                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex flex-wrap items-center gap-3 mt-3">
                        ...
                        <span className="flex items-center gap-1.5 text-xs font-black text-slate-400 uppercase tracking-widest bg-white/5 px-3 py-1.5 rounded-lg">
                          <MapPin size={14} className="text-pink-400" /> {org.location || "Global"}
                        </span>
                        <span className="flex items-center gap-1.5 text-xs font-black text-green-400 uppercase tracking-widest bg-green-500/10 px-3 py-1.5 rounded-lg border border-green-500/20">
                          <Briefcase size={14} /> {orgJobs.length} Open Position{orgJobs.length !== 1 ? "s" : ""}
                        </span>
                      </div>
                    </div>
                  </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-[1fr_360px] gap-6">
                ...
                <div className="space-y-6">
                  ...
                  <div className="bg-[#15161a] border border-white/5 rounded-3xl p-8 shadow-xl">
                    <h2 className="text-xl font-black text-white mb-5 flex items-center gap-2 uppercase tracking-tight">
                      <Building2 size={20} className="text-purple-400" /> About
                    </h2>
                    <p className="text-sm text-slate-300 leading-relaxed whitespace-pre-wrap">
                      {org.description || "A pioneering force in the digital landscape, focused on pushing the neural boundaries of Aether technology. Contact the organization for more details."}
                    </p>
                  </div>
                  ...
                  <div className="bg-[#15161a] border border-white/5 rounded-3xl p-8 shadow-xl">
                    <h2 className="text-xl font-black text-white mb-6 flex items-center gap-2 uppercase tracking-tight">
                      <Briefcase size={20} className="text-pink-400" /> Open Positions
                    ...
                    {orgJobs.length > 0 ? (
                      ...
                      <div className="text-center py-12 bg-[#0a0a0c]/40 rounded-2xl border border-white/5 border-dashed">
                        ...
                        <p className="text-sm text-slate-500 italic">No open positions detected in this sector at the moment.</p>
                      </div>
                    )}
                  </div>
                </div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="bg-[#15161a] border border-white/5 rounded-3xl p-6 shadow-xl sticky top-20">
                    <h3 className="text-sm font-black text-slate-400 uppercase tracking-widest mb-6">Organization Intel</h3>
                    ...
                    <div className="space-y-5">
                      ...
                      <InfoRow
                        ...
                        label="Headquarters"
                        value={org.location || "Global / Remote"}
                      />
                      <InfoRow
                        icon={<Briefcase size={18} className="text-green-400" />}
                        label="Open Positions"
                        value={`${orgJobs.length} role${orgJobs.length !== 1 ? "s" : ""}`}
                      />
                      {org.foundedYear && (
                        <InfoRow
